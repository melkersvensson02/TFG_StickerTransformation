...
class VitExtractor:
    ...
    def __init__(self, model_name, device):
        ...
        self.model = vits.vit_base(patch_size=8, num_classes=0)
        # Load your local weights
        state_dict = torch.load('/data/upftfg19/mfsvensson/TFG_weights/dino_vitbase8_pretrain.pth', map_location=device)
